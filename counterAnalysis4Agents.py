...
df_gwu = pd.read_csv('./agentdata/nonstat/agents_wu_48.csv', header=None)
...
df_gwl = pd.read_csv('./agentdata/nonstat/agents_gwl_48.csv', header=None)
...
plt.savefig('./agentdata/nonstat/gwu_gwl_comparison_48.pdf', format='pdf', dpi=300, bbox_inches='tight')
plt.show()

# Save the figure to 'gwl_48.pdf', which can be edited in Adobe Illustrator
# fig.savefig('./agentdata/nonstat/wu_48.pdf', bbox_inches='tight')
